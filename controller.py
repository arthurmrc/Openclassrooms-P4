...
class Controller:
    ...
    def menu(self):
        answer=int(input("Pour ajouter des joueurs tapez 1,  \n\rPour générer un nouveau round tapez 2,  \n\rPour ajouter les résultats d'un round tapez 3, "))

        if answer==1:
            return 1

        elif answer==2:
            answer2=int(input("Tapez le numéro du round que vous voulez générer, situé entre 1 et 4, "))
            if answer2==1:
                return 21
            else:
                return 22
            ...
            answer3=int(input("Tapez le numéro du round pour lequel vous voulez ajouter les résultats, situé entre 1 et 4, "))
            if answer3==1:
                return 31
            if answer3==2:
                return 32
